...
- [Build an ML Pipeline for Short-Term Rental Prices in NYC](#build-an-ml-pipeline-for-short-term-rental-prices-in-nyc)
  ...
  - [License](#license)
  - [Appendix](#appendix)
    - [Solve MLflow issue on windows](#solve-mlflow-issue-on-windows)
...
### Solve MLflow issue on windows

[Similar issue](https://github.com/mlflow/mlflow/issues/1951) appeared when calling `mlflow run . -P steps=download`.

It is a dependency conflict on windows and can be solved with
